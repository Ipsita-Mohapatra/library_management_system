...
<html>
    ...
    body{
        background-image: url('images/lib-login.jpg');
        /* margin: 0; 
         min-height: 100vh; */
        background-size: cover;
        background-position: center top; /* moves image upward */
